...
import vtkOpenGLTirtctVolumeMapper from 'vtk.js/Sources/Rendering/OpenGL/TirtctVolumeMapper';
...
export function extend(publicAPI, model, initialValues = {}) {
  ...
  publicAPI.registerOverride(
    'vtkTirtctVolumeMapper',
    vtkOpenGLTirtctVolumeMapper.newInstance
  );
  publicAPI.registerOverride(
